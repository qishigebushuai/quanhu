		...
		<div id="wrap">
			<div id="top_content">
				...
				<div id="content">
					...
					<form action='<s:url action="dept_update" namespace="dept"></s:url>' method="post">
						<table cellpadding="0" cellspacing="0" border="0"
							...
							<tr>
								...
								<td valign="middle" align="left">
									...
									<input name="dept.id" hidden value="<s:property value="dept.id"/>"/>
								</td>
							</tr>
							<tr>
								<td valign="middle" align="right">
								...
								<td valign="middle" align="left">
									<input id="name" type="text" class="inputgri" name="dept.name" value='<s:property value="dept.name"/>'/>
