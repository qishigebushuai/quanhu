		...
		<div id="wrap">
			<div id="top_content">
				...
				<div id="content">
					...
					<form action="<s:url action='user_regist' namespace='/user'></s:url>" method="post">
						<table cellpadding="0" cellspacing="0" border="0"
							...
							<tr>
								...
								<td valign="middle" align="left">
									<input id="rn" type="text" class="inputgri" name="user.realName" />
									<span><font id="tap4"></font></span><br>
								</td>
							</tr>
							<tr>
								<td valign="middle" align="right">
						...
						<p>
							...
							<a href='<s:url value="/user/login.jsp"></s:url>'>返回登录</a>
						</p>
