		...
		<div id="wrap">
			<div id="top_content">
				...
				<div id="content">
					...
					<form action='<s:url action="empt_add" namespace="/empt"></s:url>' method="post">
						<table cellpadding="0" cellspacing="0" border="0"
							...
							<tr>
								...
								<td valign="middle" align="left">
									<input id="name" type="text" class="inputgri" name="empt.name" />
									<span id="tap1"></span>
								</td>
							</tr>
							<tr>
								...
								<td valign="middle" align="left">
									<select  id="dep" name="empt.dept.id">
									</select>
								</td>
							</tr>
						</table>
